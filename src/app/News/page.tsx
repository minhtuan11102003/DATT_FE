                ...
                <div className="lg:w-[31%] md:w-[30%] mb-[20px]">
                    ...
                    <div className="w-full bg-[#f0f0f0] item mb-6">
                        <div className="w-full relative">
                            ...
                            <a className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-[20px] px-[31px] py-[35px] block w-full h-full md:text-[14px]" href="#">http:// themeforest.net/users/wpmines</a>
                        </div>
